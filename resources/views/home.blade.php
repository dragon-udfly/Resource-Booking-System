...
<body>
    ...
    <section class="banner">
        <div style="text-align: center; padding-top: 100px;">
            ...
            <p style="color: rgb(255, 255, 255); font-size: 1.2em; margin-top: 20px;">Please log in to approve hall booking and quarter reservation applications.</p>
            ...
            <a href="/book-hall" style="display: inline-block; margin-top: 30px; padding: 15px 30px; background-color: #007bff; color: white; text-decoration: none; border-radius: 5px; font-size: 1.2em; margin-left: 10px;">Book Hall</a>
