    ...
    <section class="banner">
        ...
        <div class="form-container">
            <form id="family-quarter-form" action="{{ route('familyquarter.store') }}" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <textarea id="permanent_address" name="permanent_address"
                            placeholder="with Grama Niladhari Division:" maxlength="1200" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="temporary_address">8. Temporary Address: </label>
                        <textarea id="temporary_address" name="temporary_address"
                            placeholder="with Grama Niladhari Division:" maxlength="1200"></textarea>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="monthly_salary">9. Monthly Salary (excluding allowances): <span
                                class="required">*</span></label>
                        <input type="number" id="monthly_salary" name="monthly_salary" required>
                    </div>
                    <div class="form-group">
                        <label for="f_date_of_last_salary_increment">13. Date of Last Salary Increment: <span
                                class="required">*</span></label>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="date_of_assumption_of_duties">12. Date of Assumption of Duties in Vavuniya: <span
                                class="required">*</span></label>
                        <input type="date" id="date_of_assumption_of_duties" name="date_of_assumption_of_duties" required>
                    </div>
                    <div class="form-group">
                        <label for="f_transformed_officer">14. Is applicant a transferred officer? If yes, assigned from the
                            District Secretariat? (Description about transfer order): </label>
                        <textarea id="f_transformed_officer" name="f_transformed_officer"
                            placeholder="Enter a description about transfer order documents" maxlength="1200"
                            rows="8"></textarea>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="f_property_ownership_details">1. Do you or your spouse or children under 18 own any land
                            or house in Vavuniya District? If yes, provide details: </label>
                        <textarea id="f_property_ownership_details" name="f_property_ownership_details"
                            placeholder="Enter description" maxlength="2000" cols="50" , rows="10"></textarea>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="f_previous_government_quarter_duration">Have you previously stayed in government
                            quarters? If yes, mention the duration (Years): </label>
                        <input type="number" id="f_previous_government_quarter_duration"
                            name="f_previous_government_quarter_duration">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="marking_f_department">1. Select Applicant's Department <span
                                class="required">*</span></label>
                        <select id="marking_f_department" name="marking_f_department" required>
                            <option value="">Select Department</option>
                            <option value="Officers_attached_under_the_Ministry_of_Home_Affairs">Officers attached under the
                                Ministry of Home Affairs</option>
                            <option value="Officers_attached_to_District_and_Divisional_Secretariats">Officers attached to
                                District and Divisional Secretariats</option>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="is_dependant_with_disability">3. Dependant(s) with Disability <span
                                class="required">*</span></label>
                    ...
                    <div class="form-group">
                        <label for="f_distance_of_residency">3. Distance of Residency <span
                                class="required">*</span></label>
                        <select id="f_distance_of_residency" name="f_distance_of_residency" required>
                            ...
                            <option value="Out_of_Urban_Council_Area_above_30km">Out of Urban Council Area above 30km
                            </option>
                            <option value="Out_of_Urban_Council_Area_between_00km_and_30km">Out of Urban Council Area
                                between 00km and 30km</option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label for="f_special_reason">4. Provide Special Reasons (Decided by Government Agent for Quarter
                            Reservation): </label>
                        <textarea id="f_special_reason" name="f_special_reason" placeholder="Enter Special Reason"
                            maxlength="2000" cols="50" , rows="6"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top: 20px; display: flex; align-items: center;">
                    ...
                    <label for="confirm_details" style="margin-bottom: 0; cursor: pointer;">I filled this form with
                        applicant details. All details filled here are correct.</label>
                </div>
