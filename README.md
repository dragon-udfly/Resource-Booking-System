...
1.  **Hall Bookings:** Manages the reservation of various halls (Auditorium, Conference, Training) via a **three-step approval workflow** (PA →  Administrativ Officer/Additional Government Agent/Government Agent).
